      ...
      <div className="column is-4">
        <div className="embossed-login-box">
          ...
          <form onSubmit={e => this.submitLogIn(e)}>
            ...
            <div className="field">
              <div className="control">
                <input className="input is-medium is-rounded" type="password"
                          name="password"
                          placeholder="********"
            ...
            <br />
            <button className="button is-block is-fullwidth is-danger is-medium is-rounded is-outlined" type="submit">
          ...
          <nav className="level">
            <div className="level-item has-text-centered">
              <div>
                <p className="has-text-white">Don't have an account yet?</p>
              </div>
            </div>
            <div className="level-item has-text-centered">
              <div>
